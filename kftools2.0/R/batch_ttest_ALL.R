...
if(!grepl("hta",chipType,ignore.case=T)){
  ...
  ttestSub=function(datafile=datafile){
      ...
      print("heatmapping...!")
      prettyheatmap_plot(datafile=f_names,contentfile = list,colname1 = colname1,suffixes2=suffixes,heatmap_range=1,filepathin="./",filepathout="./",heatmap_only_Sample=FALSE)
